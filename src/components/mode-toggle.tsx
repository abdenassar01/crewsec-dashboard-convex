...
export function ModeToggle() {
	...
	return <div className="flex gap-1 p-1 rounded-xl border border-secondary/20">
		{
			themes.map(
				(theme) => (
					<div
						...
						className={cn("p-2 rounded-lg ", theme === currentTheme ? 'bg-secondary/10 text-secondary' : '')}
						key={`theme-${theme}`}>
